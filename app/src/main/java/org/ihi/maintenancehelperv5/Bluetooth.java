...
import org.ihi.maintenancehelperv5.adapter.DeviceAdapter;
import org.ihi.maintenancehelperv5.comm.ObserverManager;
import org.ihi.maintenancehelperv5.operation.OperationActivity;
...
public class Bluetooth extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (view != null) {
            ...
            view = inflater.inflate(R.layout.buletooth, container, false);
...
/*        Toolbar toolbar = (Toolbar) view.findViewById(R.id.toolbar);
        ((Activity_Home) getActivity()).setSupportActionBar(toolbar);*/
                            ...
                            .setNegativeButton(R.string.cancel,
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface dialog, int which) {
                                            ((Activity_Home) getActivity()).finish();
                                        }
                                    })
